...
function EventPage() {
    return (
        <div className="relative flex flex-col items-center justify-center md:min-h-screen md:py-16  ">
            <div className="center-bg"></div>
            <div className="text-content text-center">
                <div className="text-sm md:text-lg tracking-widest text-gray-600 georgia pb-4">
                ...
                >
                    Dengan Rahmat dan Ridho Allah SWT, kami akan
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="text-sm md:text-2xl text-gray-600 georgia w-3/4">
                        Putra dari Alm. Akp. Suparyono S.H dan Hj. Rumilaeli S.
                        Pd
                    </div>
                </div>
