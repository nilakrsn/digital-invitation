...
function DetailEvent() {
    return (
        <div className="relative flex flex-col items-center justify-center md:min-h-screen text-center md:pt-16 md:pb-80 pt-24">
            <div
            ...
            <div className="mt-5">
                ...
                <div className="flex flex-col items-center justify-center md:py-12 py-5 ">
                    ...
                    <div className="text-sm md:text-2xl text-gray-600 georgia w-[20em]">
                        Jalan Raya Jatinangor, Km. 20 Bandung 45363 West Java -
                        Indonesia
                    </div>
                </div>
            </div>
