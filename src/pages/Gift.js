...
function Gift() {
    return (
        <div className="relative flex flex-col items-center md:h-[85vh] h-[55vh]">
            ...
            <div className="text-center text-gift flex flex-col">
                <div className="flex flex-col items-center">
                    ...
                    <div className="text-sm md:text-xl georgia max-w-[20em]">
                        Hadiah dan ucapan terima kasih dari Anda bisa dikirimkan
                        melalui salah satu rekening di bawah ini. Doa dan restu
                        Anda merupakan karunia terbesar dalam pernikahan kami.
                    </div>
                        ...
                        <div className="flex flex-row md:gap-6 ">
                            <div className="flex flex-col items-start">
                                ...
                                <div className="flex flex-row gap-2 items-center">
                                    <div className="text-sm md:text-xl roboto">
                                        0123456789
                                    </div>
                                    <img
