    ...
    return (
        <div className="relative flex flex-col items-center justify-end min-h-screen">
            <div className="text-center">
                ...
                <div className="text-6xl md:text-8xl tracking-wide butler mt-5" style={{ letterSpacing: 1 }}>
                    ERICK
                </div>
                <div className="text-4xl md:text-6xl snellRoundHand tracking-wider">
                    and
                </div>
                <div className="text-6xl md:text-8xl tracking-wide butler" style={{ letterSpacing: -1 }}>
                    WULAN
                </div>
                <div className="mt-10 md:mt-14">
                    <div className="text-base md:text-xl tracking-widest text-gray-600 georgia" style={{ letterSpacing: -0.1 }}>
