...
function Date() {
  ...
  const elementId = "date-section";
  const isVisible = UseScrollVisible(elementId);

  return (
    <div
      id={elementId}
      className="relative flex flex-col items-center md:min-h-screen md:mt-9"
    >
      <div className="right-flower"></div>
      <div className="img-rounded">
        <img
          src="https://res.cloudinary.com/dpcgiupja/image/upload/v1719150856/invaite/assets_3.png"
          alt=""
          className="crop-img-rounded"
        />
      </div>
      <div
        className={`mt-2 md:mt-5 text-center ${
